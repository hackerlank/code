 ...
 * @version LockService.class.php 2010-12-30 by ianzhang    
 */
class LockService extends TMLibLockService {
    /**
    ...
    public static function lock($key, $expire = 0)
    {
        ...
        return parent::lock($key, $expire, $memcache);
    }
