 ...
 * @version TMXmlFile.class.php 2008-10-23 by ianzhang
 */
class TMXmlFile extends TMAbstractXml
{
    ...
    public function __construct($path, $version = '1.0', $encoding = 'utf-8')
    {
        ...
        if(!$this->loadXML())
        {
            throw new TMXmlException(TMLibExceptionConstant::xmlError(TMLibExceptionConstant::XML_ERROR_LOAD));
        }
    }
    ...
    public function saveXML()
    {
        ...
        if($result == false)
        {
            throw new TMXmlException(TMLibExceptionConstant::xmlError(TMLibExceptionConstant::XML_ERROR_SAVE_DOM));
        }
        return $result;
    }
    ...
    public function parseXmlToArray()
    {
        ...
        if ($result === false)
        {
            throw new TMXmlException(TMLibExceptionConstant::xmlError(TMLibExceptionConstant::XML_ERROR_PARSE_ARRAY));
        }
        $array = ( array ) $result;
