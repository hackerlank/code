...
EOF;
    ...
    <div class="debug_panel_right" id="<?php echo $uri;?>" style="<?php echo $style;?>">
      ...
      <img src="debugbar/images/debug/view.png"/> <a href="javascript:show('<?php echo $uri;?>_divValues');">变量情况</a>
      ...
      <div class="mode_quicklinks" >
        <img src="debugbar/images/debug/log.png"/> <a href="javascript:show('<?php echo $uri;?>_divActionTrack');">行为监测</a>
      ...
      <div class="mode_quicklinks" >
        <img src="debugbar/images/debug/log.png"/> <a href="javascript:show('<?php echo $uri;?>_divLog');">运行日志</a>
      ...
      <div class="mode_quicklinks" >
        <img src="debugbar/images/debug/database.png"/> <a href="javascript:show('<?php echo $uri;?>_divSql');">SQL语句</a>
      ...
      <div class="mode_quicklinks" >
        <img src="debugbar/images/debug/database.png"/> <a href="javascript:show('<?php echo $uri;?>_divExplain');">需要优化的sql</a>
...
//                    }
      ...
      <div class="mode_quicklinks">
      <img src="debugbar/images/debug/time.png"/>
      <a href="javascript:show('<?php echo $uri;?>_divTimer');">运行时间: <?php echo sprintf('%.0f', ($timerData['total']["time"]) * 1000);?>ms</a>
