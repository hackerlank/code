...
$min_serveOptions['minApp']['allowDirs'] = array(realpath(dirname(dirname(__FILE__))),'//');
...
function yuiJs($js) {
    ...
    Minify_YUICompressor::$jarFile = '/home/demo/src/web/min/lib/yuicompressor-2.4.2.jar';
    Minify_YUICompressor::$tempDir = '/tmp';
    return Minify_YUICompressor::minifyJs($js);
}
$min_serveOptions['minifiers']['application/x-javascript'] = 'yuiJs';//array('JSMinPlus', 'minify');
*/