 ...
 */
 var appConfig = {
      ...
      domain:    'http://test.qq.com/',				//定义项目域名，外包也是需要设置是qq.com结尾的域名
      rootPath:  'http://appmedia.qq.com/media/jslib/',		//jslib所在的访问路径
      appid:     4008401,					//定义项目所用到的APPID
      tamsid:    641009454,					//定义项目的活动ID，这个和监测PV/UV相关

      //以下配置修改请谨慎
      autoload: ['core','speed/mo2','auth/auth','utils/util','verifycode/verifycode', 'service/vote', 'service/upload']
 };
